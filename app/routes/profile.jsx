                ...
                >
                  <div className={styles.vehicleInfo}>
                    ...
                    <span className="w-[95%] wrap-break-word">
                      Asesor: {policy.asesor}
                    </span>
                    <span className="w-[95%] wrap-break-word">
                      {policy.fecha_creacion} - {policy.fecha_fin}
                    </span>
                    <span className="w-[95%] wrap-break-word">
                      tipo de pago: {policy.nombre_tipo_pago}
                    </span>
                  </div>
                </div>
              ))}
            ...
            >
              {vehicles.map((vehicle) => (
                <div
                  ...
                  className={`${styles.vehicleItem}`}
                  onClick={() => navigate("/vehicle/" + vehicle.matricula)}
                >
                  <div className={styles.vehicleInfo}>
                    <span className={styles.vehiclePlate}>
                      {vehicle.matricula}
            ...
            >
              {accidentReport.map((report) => (
                <div
                  key={report.id}
                  className={`${styles.vehicleItem}`}
                  onClick={() => navigate("/accidentReport/" + report.id)}
                >
                  <div className={styles.vehicleInfo}>
                    <span className={styles.vehiclePlate}>
